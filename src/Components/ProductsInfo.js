const ProductsInfo = {
  prod1: {
    ...
    details:
      "Set includes 1 fitted sheet, 1 flat (top) sheet plus pillowcase(s)* *Full and Queen include 2 standard pillowcases; King and Cal King include 2 king-size pillowcases; Twin and TwinXL include 1 standard pillowcase Deep pockets stretch to fit both regular and deep pocket mattresses up to 20” Inside Top/Bottom label makes bed-making easy Pre-washed and packaged in a reusable drawstring bag made from scrap fabric",
    care:
